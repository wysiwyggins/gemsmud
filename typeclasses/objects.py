...
class Counter(Readable):
    def at_desc(self, looker=None):
        ...
        cnt -= ObjectDB.objects(db_typeclass_path="typeclasses.hybrid_room.HybridRoom").count()
        cnt -= ObjectDB.objects(db_typeclass_path="typeclasses.hybrid_room.typeclasses.exits.Exit").count()
